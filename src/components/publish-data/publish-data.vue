      ...
      <el-row>
        <el-col :sm="20" :md="18" :lg="14">
          <el-form :model="dataInfo" :rules="rules" ref="dataInfo">
            <el-form-item label="网站名称" prop="dataName">
              <el-input placeholder="请输入网站官方名称" v-model="dataInfo.dataName" clearable></el-input>
            </el-form-item>
            <el-form-item label="网站Logo" prop="dataIcon">
              <el-input v-model="dataInfo.dataIcon" placeholder="请输入网站官网Logo地址" clearable>
                <el-select slot="prepend" v-model="dataInfo.selectIcon" placeholder="请选择">
                  <el-option label="http://" value="http://"></el-option>
                  <el-option label="https://" value="https://"></el-option>
                </el-select>
              </el-input>
            </el-form-item>
            <el-form-item label="网站地址" prop="dataWebsite">
              <el-input v-model="dataInfo.dataWebsite" placeholder="请输入网站地址" clearable>
                <el-select slot="prepend" v-model="dataInfo.selectSit" placeholder="请选择">
                  <el-option label="http://" value="http://"></el-option>
                  <el-option label="https://" value="https://"></el-option>
                </el-select>
              </el-input>
            </el-form-item>
            <el-form-item label="网站介绍" prop="dataIntroduce">
              <el-input
                type="textarea"
                :autosize="{ minRows: 4 }"
                placeholder="请输入网站介绍"
            ...
            <el-form-item label="网站分类" prop="dataType">
              <el-select class="selectTag" v-model="dataInfo.dataType" placeholder="请选择网站分类">
                <el-option
            ...
            <el-form-item label="标签" prop="dataTag">
              <el-select class="selectTag" v-model="dataInfo.dataTag" placeholder="请选择网站标签">
                <el-option
            ...
            <el-form-item>
              <el-button type="primary" @click="publish('dataInfo')">立即发布</el-button>
