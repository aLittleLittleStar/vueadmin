...
module.exports = {
  ...
  userRegister(req, res, next) {
    ...
    pool.getConnection((err, connection) => {
      connection.query(
        sql,
        [params.name, params.pass, params.sex, params.birth],
        (err, result) => {
          if (err) {
            return callback(err);
          }
  ...
  upBaseInfo(req, res, next) {
    ...
    pool.getConnection((err, connection) => {
      connection.query(
        sql,
        [params.name, params.sex, params.birth, params.id],
        (err, result) => {
          if (err) {
            return callback(err);
          }
  ...
  updateStar(req, res, next) {
    pool.getConnection((err, connection) => {
      ...
      connection.query(
        sql,
        [params.articlelikes, params.articleid],
        (err, result) => {
          if (err) {
            res.send({ status: -1 });
            console.log("err:", err);
  ...
  updateColl(req, res, next) {
    pool.getConnection((err, connection) => {
      ...
      connection.query(
        sql,
        [params.articlecollection, params.articleid],
        (err, result) => {
          if (err) {
            res.send({ status: -1 });
            console.log("err:", err);
  ...
  searchUserStar(req, res, next) {
    pool.getConnection((err, connection) => {
      ...
      connection.query(
        sql,
        [params.articleid, params.username],
        (err, result) => {
          if (err) {
            res.send({ status: -1 });
            console.log("err:", err);
  ...
  upsearchUserStar(req, res, next) {
    pool.getConnection((err, connection) => {
      ...
      connection.query(
        sql,
        [params.starstatus, params.articleid, params.username],
        (err, result) => {
          if (err) {
            res.send({ status: -1 });
            console.log("err:", err);
  ...
  upsearchUserColl(req, res, next) {
    pool.getConnection((err, connection) => {
      ...
      connection.query(
        sql,
        [params.collstatus, params.articleid, params.username],
        (err, result) => {
          if (err) {
            res.send({ status: -1 });
            console.log("err:", err);
